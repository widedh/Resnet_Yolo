...
def label_to_tensor(frame, imgsize=(224, 224), gridsize=(11,11), classes=3, bboxes=2):
    ...
    return tensor
def augument_data(label, frame, imgsize=(224, 224), folder='C:/Users/widwid/Desktop/YOLO_ResNet-master/udacity-object-detection-crowdai/'):
    '''
...
#    print("helllooooooooooooooooooo"+img)
...
def generator(label_keys, label_frames, batch_size=64, folder='C:/Users/widwid/Desktop/YOLO_ResNet-master/udacity-object-detection-crowdai/'):
    '''
    Generator function
    # Arguments
